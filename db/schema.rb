...
ActiveRecord::Schema[7.2].define(version: 2025_03_25_155046) do
  ...
  create_table "disease_specialties", force: :cascade do |t|
    t.bigint "disease_id", null: false
    t.bigint "specialty_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["disease_id"], name: "index_disease_specialties_on_disease_id"
    t.index ["specialty_id"], name: "index_disease_specialties_on_specialty_id"
  end
  ...
  add_foreign_key "disease_specialties", "diseases"
  add_foreign_key "disease_specialties", "specialties"
